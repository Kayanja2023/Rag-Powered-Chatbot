#!/usr/bin/env python3
"""
Tests for recursion prevention - no Unicode
"""
...
def test_fallback_detection():
    ...
    print("PASS: Fallback detection test")
...
def run_all_tests():
    ...
    try:
        ...
        print("Recursion prevention should work correctly.")
        return True
...
if __name__ == "__main__":
    ...
    if success:
        print("\nThe fixed Streamlit app should work without recursion!")
